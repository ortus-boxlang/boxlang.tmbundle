...
try {
    const langConfig = require('./src/boxlang-language-config.js');
...
// Test monarch tokens
try {
    const monarchTokens = require('./src/boxlang-monarch-tokens.js');
...
// Test theme
try {
    const theme = require('./src/boxlang-theme.js');
